...
router.get('/homework-by-id/:id',(req,res,next)=>{
    ...
    Homework.findOne({_id:req.params.id}).then(result=>{
        return res.status(200).json({
            'success':true,
            "data":result,
...
router.put('/update-homework/:id',upload.single('attachment'),(req,res,next)=>{
...
router.delete('/delete-homework/:id',(req,res,next)=>{
    ...
    Homework.deleteOne({_id:req.params.id}).then(result=>{
        res.status(200).json({
            'success':true,
            "data":result,
